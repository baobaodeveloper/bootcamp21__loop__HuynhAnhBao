...
document.getElementById("creat-div").addEventListener("click", () => {
  ...
  const redDiv = `<div style="height: 100px; width: 400px; background-color: red"></div>`;
  const blueDiv = `<div style="height: 100px; width: 400px; background-color: blue; margin-bottom: 10px"></div>`;
